...
public class CodeMutatorTest {
    ...
    private final GeneriCodeMutator mutator = new GeneriCodeMutator();

    @Test
    public void testContent() {
        final MutationContext context = createContext();
        final MutationConfig config = createConfig().add(GeneriCodeMutator.INTERNAL_PROP_VALUE, "T1");
    ...
    public void testAttribute() {
        ...
        final MutationConfig config = createConfig().add(GeneriCodeMutator.INTERNAL_PROP_VALUE, value).add("attribute", attrName);
        this.mutator.mutate(context, config);
    ...
    public void testUnexistingAttribute() {
        final String attrName = "attr";
        final MutationContext context = createContext();
        final MutationConfig config = createConfig().add(GeneriCodeMutator.INTERNAL_PROP_VALUE, "T1").add("attribute", attrName);
