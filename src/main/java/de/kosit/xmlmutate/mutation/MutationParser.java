...
public class MutationParser {
    ...
    public class MutationParserListener extends de.kosit.xmlmutate.mutation.parser.MutationBaseListener {
        private final MutationDocumentContext context;
        ...
        public MutationParserListener(final MutationDocumentContext context) {
     ...
     */
    public List<Mutation> parse(final MutationDocumentContext context) {
    ...
    private List<Mutation> createErrorMutation(final MutationDocumentContext context, final Exception exception) {
