...
public class DocumentParser {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DocumentParser.class);
    ...
    private static class NamespaceMapping {
        ...
        private static class NS {
            ...
            @java.lang.SuppressWarnings("all")
            public NS(final String namespace, final String prefix, final boolean declared) {
            ...
            @java.lang.SuppressWarnings("all")
            public NS(final String namespace, final String prefix) {
                this.namespace = namespace;
                this.prefix = prefix;
            }
    ...
    private static class PositionalHandler extends DefaultHandler2 {
        ...
        @java.lang.SuppressWarnings("all")
        public PositionalHandler(final Document doc) {
            this.doc = doc;
        }
    }
    ...
    private static Document readDocument(final InputStream input, final boolean saveMode) throws IOException, SAXException, ParserConfigurationException {
