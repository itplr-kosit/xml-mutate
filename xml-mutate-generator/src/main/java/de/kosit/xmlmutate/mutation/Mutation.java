...
public class Mutation {
     ...
     * Constructor.
     *
     * @param context    der {@link MutationDocumentContext}
     * @param identifier ein Name / Bezeichner für die Mutation
     */
    public Mutation(final MutationDocumentContext context, final String identifier) {
        this.context = context;
        this.identifier = identifier;
    }

    public Mutation(final MutationDocumentContext context, final String identifier, final MutationConfig configuration) {
        this(context, identifier);
        this.configuration = configuration;
    }

    public Mutation(final MutationDocumentContext context, final String identifier, final MutationConfig configuration, final Mutator mutator) {
    ...
    public MutationDocumentContext getContext() {
        return this.context;
    }
