...
public class ValidateAction implements RunAction {
    ...
    private void schematronValidation(final Mutation mutation) {
        ...
        final List<SchematronRuleExpectation> actualUnknowns = unknownRules.stream().filter(e -> Collections.frequency(unknownRules, e) > 1).distinct().collect(Collectors.toList());
        // Set validation state
